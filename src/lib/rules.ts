...
export const LCT_EXCLUDED_PATIENT_NAMES = [
  "นายชิงชัย ทองมาลา",
  "นางประดิษฐ์ สุภาพทอง",
  "นางมนต์ แสนศรี",
  "นางเยี่ยม คำตั้งหน้า",
  "นายพรมาเทะ สุภาพทอง",
  "ด.ญ.ชาลิสา บัวอ่อน",
  "นางก่อง คำตั้งหน้า",
  "นางเพ็ญศิริ สิงห์คำมา",
  "นายวิสาน นกทอง",
  "นางพัชณีย์ นามโคตร",
  "นายวิชกร บัวอ่อน",
  "นายเอื้อ เหมเศร็คำ",
  "ด.ช.พีระพัฒน์ พรหมพล",
  "นายอนงค์ พรหมเชษฐา",
  "นายบุญ โยมเงิน",
  "นางอวยพร ยังโยธา",
  "นางบุญมี ฐานพรหม",
...
function normalizePersonName(value?: string): string {
  return (value ?? "")
    .replace(/^(นาย|นางสาว|นาง|น\.ส\.|ด\.ญ\.|ด\.ช\.|เด็กหญิง|เด็กชาย|ดญ|ดช)/u, "")
    .replace(/[\s.]+/g, "")
    .trim();
}
